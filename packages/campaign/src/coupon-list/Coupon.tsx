import type { CouponProps } from "./PropsType";
import { Checkbox, ConfigProviderContext } from "@react-vant-next/ui";
import { createNamespace, mergeProps, padZero } from "@react-vant-next/utils";
