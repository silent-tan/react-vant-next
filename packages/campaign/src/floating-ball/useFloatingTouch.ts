import type { FloatingBallProps } from "./PropsType";
import { useIsomorphicLayoutEffect, useSetState } from "@react-vant-next/hooks";
import { raf, unitToPx } from "@react-vant-next/utils";
...
interface UseFloatingTouchProps {
  /** 目标dom实例 */
  target?: HTMLElement;
  /** 初始化偏移量 */
...
function useFloatingTouch(props?: UseFloatingTouchProps) {
