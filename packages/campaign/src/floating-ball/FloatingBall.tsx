...
import { createNamespace, mergeProps, raf, throttle } from "@react-vant-next/utils";
...
function FloatingBall({ ref, ...p }: FloatingBallProps & { ref?: React.RefObject<FloatingBallInstance | null> }) {
