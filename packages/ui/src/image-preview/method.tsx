import type { CloseParams, ImagePreviewProps, ImagePreviewStatic } from "./PropsType";
import { Clear } from "@react-vant-next/icons";
import { canUseDom, noop, render, resolveContainer, unmount } from "@react-vant-next/utils";
...
// 可返回用于销毁此弹窗的方法
function open(props: ImagePreviewProps) {
  if (!canUseDom())
    return null;
