...
import { useRefState, useUpdateEffect } from "@react-vant-next/hooks";

import { isDate, mergeProps, padZero } from "@react-vant-next/utils";
...
function DatePicker({ ref, ...p }: DatePickerProps & { ref?: React.RefObject<DateTimePickerInstance | null> }) {
