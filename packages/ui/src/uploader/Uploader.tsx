...
import { useIsomorphicLayoutEffect, usePropsValue } from "@react-vant-next/hooks";
import { Photograph } from "@react-vant-next/icons";
// Utils
import { createNamespace, extend, getSizeStyle, mergeProps } from "@react-vant-next/utils";
import cls from "clsx";
import React, { useImperativeHandle, useRef, useState } from "react";
// Components
import ImagePreview from "../image-preview";
import { UploaderPreviewItem } from "./UploaderPreviewItem";
import { filterFiles, isImageFile, isOversize, readFileContent } from "./utils";

const [bem] = createNamespace("uploader");

function Uploader({ ref, ...p }: UploaderProps & { ref?: React.RefObject<UploaderInstance | null> }) {
  ...
  const renderUploadIcon = () => {
    if (props.uploadIcon) {
      return React.cloneElement<any>(props.uploadIcon as React.ReactElement, {
