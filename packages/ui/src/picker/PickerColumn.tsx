import type { PickerColumnOption, PickerColumnProps } from "./PropsType";
import { useIsomorphicLayoutEffect, useSetState, useTouch } from "@react-vant-next/hooks";
import { createNamespace, range, unitToPx } from "@react-vant-next/utils";
...
const PickerColumn = memo<
  PickerColumnProps & { ref?: React.ForwardedRef<{ stopMomentum: () => void }> }
    >(
    ({ ref, ...props }: PickerColumnProps & { ref?: React.RefObject<{ stopMomentum: () => void } | null> }) => {
