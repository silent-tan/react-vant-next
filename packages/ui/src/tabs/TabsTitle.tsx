...
import type { TabsTitleProps } from "./PropsType";
import { createNamespace, isObject } from "@react-vant-next/utils";
...
function TabsTitle({ ref, ...props }: TabsTitleProps & { ref?: React.RefObject<HTMLDivElement | null> }) {
  const {
    type,
    color,
    isActive,
