import type { LoadMoreInstance, LoadMoreProps } from "./PropsType";
import { getScrollParent, useLockFn, useThrottleFn } from "@react-vant-next/hooks";
...
function LoadMore({ ref, ...p }: LoadMoreProps & { ref?: React.RefObject<LoadMoreInstance | null> }) {
  const props = mergeProps(p, {
    threshold: 300,
  });
  const { locale } = React.use(ConfigProviderContext);
