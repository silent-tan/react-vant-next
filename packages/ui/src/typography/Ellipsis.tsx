...
import type { EllipsisProps } from "./PropsType";
import { useIsomorphicLayoutEffect, useResizeEffect } from "@react-vant-next/hooks";
import { mergeProps, withStopPropagation } from "@react-vant-next/utils";
