import type { PasswordInputInstance, PasswordInputProps } from "./PropsType";
import { useSetState, useUpdateEffect } from "@react-vant-next/hooks";
import {
  addUnit,
  createNamespace,
  formatNumber,
...
import { BORDER_LEFT, BORDER_SURROUND } from "../constants";
...
function PasswordInput({ ref, ...p }: PasswordInputProps & { ref?: React.RefObject<PasswordInputInstance | null> }) {
