import type { SwiperInstance, SwiperProps } from "./PropsType";
import { animated, useSpring } from "@react-spring/web";
import { useIsomorphicLayoutEffect, useRefs, useRefState, useUpdateEffect } from "@react-vant-next/hooks";
import { bound, createNamespace, devWarning, mergeProps, noop } from "@react-vant-next/utils";
...
import { isScrollTarget, modulus } from "./utils";

const [bem] = createNamespace("swiper");

function Swiper({ ref, ...p }: SwiperProps & { ref?: React.RefObject<SwiperInstance | null> }) {
      ...
      return (
        ...
        >
          ...
          {React.Children.map(validChildren, (child, index) => {
            return (
              // @ts-expect-error wait react-spring@10
              <animated.div
