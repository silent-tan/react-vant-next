...
import type { TextAreaInstance } from "../text-area/PropsType";
import type { FieldInstance, FieldProps, FieldTooltipProps } from "./PropsType";
import { Clear, QuestionO } from "@react-vant-next/icons";
import { addUnit, createNamespace, isDef, mergeProps } from "@react-vant-next/utils";
...
import { FIELD_KEY } from "./style/contants";

const [bem] = createNamespace("field");

function Field({ ref, ...p }: FieldProps & { ref?: React.RefObject<FieldInstance | null> }) {
