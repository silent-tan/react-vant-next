...
import { useClickAway, useEventListener, useTouch } from "@react-vant-next/hooks";
import { callInterceptor, createNamespace, getRect, isDef, mergeProps, preventDefault, range } from "@react-vant-next/utils";
...
function SwipeCell({ ref: instanceRef, ...p }: SwipeCellProps & { ref?: React.RefObject<SwipeCellInstance | null> }) {
