...
import type { SearchInstance, SearchProps } from "./PropsType";
import { Search as SearchIco } from "@react-vant-next/icons";
import { createNamespace, mergeProps, preventDefault } from "@react-vant-next/utils";
...
function Search({ ref, ...p }: SearchProps & { ref?: React.RefObject<SearchInstance | null> }) {
