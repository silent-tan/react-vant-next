import type { PullRefreshProps, PullRefreshStatus } from "./PropsType";
import { getScrollParent, useEventListener, useSetState, useTouch, useUpdateEffect } from "@react-vant-next/hooks";
import { createNamespace, getScrollTop, mergeProps, preventDefault } from "@react-vant-next/utils";
...
const PullRefresh: React.FC<PullRefreshProps> = (p) => {
  ...
  const track = useRef<HTMLDivElement>(void 0);
